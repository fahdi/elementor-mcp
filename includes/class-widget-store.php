...
class EMCP_Tools_Widget_Store {
	...
	/**
	 * One page of widgets, plus the totals needed to draw a pager.
	 *
	 * list_widgets() stays as it is for the MCP tools, which want the whole
	 * list in a single call. The admin table renders each row's compiled PHP,
	 ...
	 */
	public static function list_widgets_page( string $status = 'any', int $page = 1, int $per_page = EMCP_Tools_Sandbox_List_Query::PER_PAGE ): array {
